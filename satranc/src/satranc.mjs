...
var SatrancAi = (function() {
  var _scriptDir = './wasm/satranc.wasm';
  
  return (
function(SatrancAi) {
  SatrancAi = SatrancAi || {};

var Module = typeof SatrancAi !== "undefined" ? SatrancAi : {};
...
const wasmBinaryFile = './wasm/satranc.wasm';
...
var _doMove = Module["_doMove"] = function() {
 return (_doMove = Module["_doMove"] = Module["asm"]["s"]).apply(null, arguments);
};

var _aiMove = Module["_aiMove"] = function() {
 return (_aiMove = Module["_aiMove"] = Module["asm"]["t"]).apply(null, arguments);
};
...
run();
  ...
  return SatrancAi.ready
}
);
})();
export default SatrancAi;